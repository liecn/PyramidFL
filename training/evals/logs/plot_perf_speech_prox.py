...
def main(files):
    ...
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_speech_prox.png')

main([
    'google_speech/0808_085231_36612/aggregator/training_perf',
    'google_speech/0812_031735_19636/aggregator/training_perf',
    'google_speech/0814_124934_58011/aggregator/training_perf'])
