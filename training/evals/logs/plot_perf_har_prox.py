...
def main(files):
    ...
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_har_prox.png')


# shufflenet
main([
'har/0816_191221_10344/aggregator/training_perf',
'har/0816_191224_7093/aggregator/training_perf',
'har/0816_194517_59004/aggregator/training_perf',
])
