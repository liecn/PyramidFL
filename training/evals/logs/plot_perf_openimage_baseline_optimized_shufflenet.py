...
def main(files):
    ...
    plot_line(metrics, walltime, setting_labels, 'Training Time (hours)', plot_metric, 'time_to_acc_openimage_baseline_optimized_shufflenet.png')

main(['openimage/0804_053601_2756/aggregator/training_perf',
...
'openimage/0105_154527_14733/aggregator/training_perf',
'openimage/0101_175906_3317/aggregator/training_perf'])
