...
def main(files):
    ...
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_stackoverflow_prox.png')

main([
    'stackoverflow/0815_073547_7750/aggregator/training_perf',
    'stackoverflow/0815_073149_45657/aggregator/training_perf',
    'stackoverflow/0117_073156_16674/aggregator/training_perf',
])
