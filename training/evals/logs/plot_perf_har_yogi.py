...
def main(files):
    ...
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_har_yogi.png')


# shufflenet
main(['har/0816_173449_77/aggregator/training_perf',
'har/0816_173452_45079/aggregator/training_perf',
'har/0816_174536_52223/aggregator/training_perf',
])
